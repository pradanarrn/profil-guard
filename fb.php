...
pilih:
    system($bersih);
    echo"
$red Pencipta  : Pranasonix
$red Type      : Profil Guard Facebook 
$red Facebook  : Pranasonix
$lightred Youtube     : https://www.youtube.com/channel/UCcQni_R7gIWiSWYV_6UZrxA
$blue Version   : 2.0 
$darkgray Date      : $date 
";
    echo " 
...
";
        ...
        sleep(1);
        echo "$blue Sampai Bertemu Kembali Dan Subscribe Channel Pranasonix : $cyan " . $me->name;
        sleep(1.5);
        echo "
";
    }
